...
namespace Ngr.Ui_Tests.DataProviders
{
    public class SettingsFileReader
    {
        ...
        public string getCollectorPortalBaseUrl()
        {
            return envConfig.GetSection("guiEnvSettings").GetValue<string>("baseCollectorPortalGUIUri");
        }
        public string getPayerPortalBaseUrl()
        {
            return envConfig.GetSection("guiEnvSettings").GetValue<string>("basePayerPortalGUIUri");
        }
