...
namespace Ngr.Ui_Tests
{
    ...
    public sealed class Hooks
    {
        ...
        public void BeforeScenario()
        {
            ...
            WebDriverHelpers.browseURL(_scenarioContext, settingsFile.getPayerPortalBaseUrl());
            WebDriverHelpers.browseURL(_scenarioContext, settingsFile.getCollectorPortalBaseUrl());
        }
        [AfterScenario]
